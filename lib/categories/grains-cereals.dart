...
import 'package:foodtrack/overlays-drawer-etc/addgrains.dart';
import 'package:foodtrack/overlays-drawer-etc/details-grains.dart';

class GrainsCereals extends StatelessWidget {
  const GrainsCereals({super.key});

  @override
  Widget build(BuildContext context) {
    final AddGrains addGrains = AddGrains();
