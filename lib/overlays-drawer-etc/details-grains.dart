...
class DetailsGrains extends StatefulWidget {
  const DetailsGrains({super.key});

  @override
  _DetailsGrainsState createState() => _DetailsGrainsState();
}

class _DetailsGrainsState extends State<DetailsGrains> {
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const GrainsCereals(),
                    ),
                  );
                },
                      ...
                      child: Column(children: [
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            filled: true,
                            fillColor: Colors.white,
                            hintText: "time before food goes bad (days:hours:minutes)",
                            hintMaxLines: 2,
                          ),
