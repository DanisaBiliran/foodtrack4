...
class DetailsMeats extends StatefulWidget {
  const DetailsMeats({super.key});

  @override
  DetailsMeatsState createState() => DetailsMeatsState();
}

class DetailsMeatsState extends State<DetailsMeats> {
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const MeatsDairy(),
                    ),
                  );
                },
